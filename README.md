...
1. Click **New Project** or select **File > New**.  
2. Enter the project name and a brief description.  
3. Use the text area to write your content. The editor supports simple Markdown syntax.  
4. Use the preview panel to see how your README will look.

### Edit Existing README Files

1. Choose **File > Open**.  
2. Navigate to your existing README.md file.  
3. Make your edits directly in the editor.  
4. Save changes using **File > Save**.

### Export Your README.md
